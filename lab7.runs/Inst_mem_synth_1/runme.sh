...
HD_PWD='D:/study/COD/lab/lab7_cpu_pipeline/lab7/lab7.runs/Inst_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inst_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Inst_mem.tcl
